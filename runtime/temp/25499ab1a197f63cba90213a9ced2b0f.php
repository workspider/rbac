<?php /*a:2:{s:67:"/var/www/manager_cmlaw/application/home/view/lichong/fankuisee.html";i:1545186973;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <form method="post" id="lichongAddForm" novalidate="novalidate">
            <table class="table table-bordered table-border-book">
                    ...
                    <td class="text-center">
                        <div class="width-100">
                            <label class="radio-inline">
                                <input type="radio" name="fankui_status" value="1" checked> 无利冲
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="fankui_status" value="4"> 有利冲
                            </label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="width-100">
                            <textarea class="form-control" rows="3" name="fankui_content"
            ...
            <div class="text-center">
                <input type="hidden" name="lichongid" class="form-control" value="<?php echo htmlentities($data['info']['idlichong']); ?>"/>
    ...
    <div class="col-md-12">
        <div style="width: 100%;line-height: 40px;background-color: #e8e8e8">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:18px;vertical-align:middle">
                        ...
                        <span style="font-family:'PingFangSC-Regular', 'PingFang SC';font-size:16px;">查询概述</span>
                    </span>
        </div>
        <p></p>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td colspan="3" class="text-danger"><?php echo htmlentities(substr($data['info']['gongshi_time'],0,10)); ?></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    $("#lichongAddForm").validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                url: web_url + '/home/lichong/fankuiSave',
                type: "post",
                dataType: "json",
                ...
                success: function (obj) {
                    if (obj.status === 1001) {
                        ...
                        $(window).attr('location', web_url + "/home/lichong/fankui");
                    } else {
