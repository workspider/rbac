<?php /*a:2:{s:65:"/var/www/manager_cmlaw/application/rbac/view/quanxian/create.html";i:1545186971;s:61:"/var/www/manager_cmlaw/application/rbac/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <td>
                         <ul style="list-style-type: none">
                            ...
                            <li>
                                ...
                                <?php endif; ?>
                                <label for="quanxian[]"><?php echo htmlentities($list['name']); ?></label>
                                <ul style="list-style-type: none">
                                    <?php if(is_array($list['list']) || $list['list'] instanceof \think\Collection || $list['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <li>
                                        <?php if(in_array(($list['id']), is_array($data['info']['rules'])?$data['info']['rules']:explode(',',$data['info']['rules']))): ?>
                                        <input type="checkbox" name="quanxian[]" value="<?php echo htmlentities($list['id']); ?>" checked>
                                        <?php else: ?>
