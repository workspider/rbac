<?php /*a:2:{s:59:"/var/www/manager_cmlaw/application/home/view/work/edit.html";i:1545186975;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-no-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <input name="work_end_date" type="text" readonly value="<?php echo htmlentities($data['info']['work_end_date']); ?>"
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <input name="work_unit" type="number" class="form-control" placeholder="计时" value="<?php echo htmlentities($data['info']['work_unit']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <select name="work_type" class="form-control chosen-select" data-placeholder="请选择工作类型">
                                <option value=""></option>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-70">
                            <select id="typeid" name="typeid" class="form-control" data-placeholder="请选择工作类型">
                                <option value="">请选择工作类型</option>
                                <?php if(is_array($data['type']) || $data['type'] instanceof \think\Collection || $data['type'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
                                <optgroup label="<?php echo htmlentities($type['type_name']); ?>">
                                    <?php if(is_array($type['type']) || $type['type'] instanceof \think\Collection || $type['type'] instanceof \think\Paginator): $i = 0; $__LIST__ = $type['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;if($type['idtype'] == $data['info']['typeid']): ?>
                                    <option value="<?php echo htmlentities($type['idtype']); ?>" selected><?php echo htmlentities($type['type_name']); ?></option>
                                    <?php else: ?>
                                    <option value="<?php echo htmlentities($type['idtype']); ?>"><?php echo htmlentities($type['type_name']); ?></option>
                                    <?php endif; ?>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </optgroup>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-70">
                            <textarea name="work_title" class="form-control" rows="6"><?php echo htmlentities($data['info']['work_title']); ?></textarea>
                        </div>
                    </td>
                </tr>
        ...
        <div class="col-md-12">
            <div class="text-center">
                ...
                <input type="hidden" name="id" value="<?php echo htmlentities($data['info']['idwork']); ?>">
