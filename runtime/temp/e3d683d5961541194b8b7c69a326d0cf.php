<?php /*a:2:{s:78:"/var/www/manager_cmlaw/application/home/view/kehu/qiye/create_empty_step2.html";i:1546853516;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <form method="post" id='kehuCreateForm'>
        ...
        <div class="col-md-12">
            <table class="table table-no-bordered">
                <tbody>
                <tr>
                    <td style="width: 20%" class="input-title text-right"><span>公司名称</span></td>
                    <td style="width: 80%">
                        <div class="width-40">
                            <input type="text" name="kehu_name" class="form-control" value="">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_faren" class="form-control" value="">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <select name="leixing" class="form-control chosen-select " data-placeholder="选择公司类型">
                                <option value=""></option>
                                <?php if(is_array($gongsileixing) || $gongsileixing instanceof \think\Collection || $gongsileixing instanceof \think\Paginator): $i = 0; $__LIST__ = $gongsileixing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gongsi): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($gongsi['qiyeleixing_name']); ?>"><?php echo htmlentities($gongsi['qiyeleixing_name']); ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </td>
                ...
                <tr>
                    <td class="input-title text-right"><span>注册证号</span></td>
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_xinyongdaima" class="form-control" value="">
                        </div>
                    </td>
                </tr>

                <tr>
                    <td class="input-title text-right"><span>注册资本金</span></td>
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_ziben" class="form-control" value="">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <textarea name="kehu_dizhi" class="form-control" rows="6"></textarea>
                        </div>
                    </td>
        ...
        <div class="col-md-12">
            <table class="table table-no-bordered">
                <tbody>
                <tr>
                    <td style="width: 20%;" class="input-title text-right"><span>自定义行业</span></td>
                    <td style="width: 80%;">
                        <div class="width-40">
                            <select name="kehu_hangye[]" multiple class="form-control chosen-select"
                                    data-placeholder="选择自定义行业">
                                <option value=""></option>
                                <?php if(is_array($hangyeleixing) || $hangyeleixing instanceof \think\Collection || $hangyeleixing instanceof \think\Paginator): $i = 0; $__LIST__ = $hangyeleixing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hangyeleixing): $mod = ($i % 2 );++$i;?>
        ...
        <div class="text-center">
            <input type="hidden" name="kehu_type" class="form-control" value="1">
            <input type="hidden" name="number" value="<?php echo htmlentities($data['number']); ?>">
            <a href="<?php echo url('kehu/create',['type'=>'qiye','step'=>1]); ?>" class="btn btn-default">返回上一步</a>
            <button class="btn btn-primary">保存客户信息</button>
        </div>
    </form>
</div>
    ...
    $(function () {
        ...
        $("#kehuCreateForm").validate({
            ...
            submitHandler: function (form) {
                $.ajax({
                    url: web_url + '/home/kehu/shoudong_save',
                    type: "post",
                    dataType: "json",
