<?php /*a:2:{s:61:"/var/www/manager_cmlaw/application/home/view/auth/create.html";i:1559041232;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-tabs-order">
            ...
            <li role="presentation" class="active">
                <a href="<?php echo url('auth/create'); ?>">菜单添加</a>
            </li>
        </ul>
    </div>
    <div class="col-md-12">
        <form method="post" id='createForm'>
            <table class="table table-bordered">
                    ...
                    <td>
                        <div class="width-30">
                            <select name="pid" class="form-control" multiple size="5">
                                ...
                                <?php if(is_array($list['sub']) || $list['sub'] instanceof \think\Collection || $list['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-60">
                            <input name="url" type="text" class="form-control" placeholder="格式：home/user/create">
                        </div>
                    </td>
                </tr>
