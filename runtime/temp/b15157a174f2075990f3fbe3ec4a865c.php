<?php /*a:2:{s:78:"/var/www/manager_cmlaw/application/home/view/kehu/system/kehu_qiyeleixing.html";i:1545186989;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-6">
        <table class="table table-border-order">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($list['qiyeleixing_name']); ?></td>
                <td><?php echo htmlentities($list['beizhu']); ?></td>

                <td class="text-right width160">
                    <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">

                        <button type="button" data-toggle="hr_zhiwei" data-align="update" data-bind="<?php echo htmlentities($list['idkehu_qiyeleixing']); ?>"
                                class="btn btn-link btn-default">修改
                        </button>
                        <button type="button" data-toggle="hr_zhiwei" data-align="delete" data-bind="<?php echo htmlentities($list['idkehu_qiyeleixing']); ?>"
        ...
        <form method="post" id='hrCreateForm'>
            ...
            <h4>公司类型修改
                <button type="button" data-toggle="hr_zhiwei" data-align="create" data-bind=""
                        class="btn btn-link btn-default btn-sm">新增公司类型
                </button>
            </h4>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-100">
                            <input name="name" type="text" class="form-control" value="<?php echo htmlentities($data['info']['qiyeleixing_name']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <input name="id" type="hidden" value="<?php echo htmlentities($data['info']['idkehu_qiyeleixing']); ?>">
            <?php else: ?>
            <h4>公司类型新增</h4>
            <table class="table table-bordered">
                <tbody>
...
<script>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'hr_zhiwei':
                switch (align) {
                    case 'create':
                        $(location).attr('href', web_url + '/home/kehu/system/type/kehu_qiyeleixing');
                        break;
                    case 'update':

                        $(location).attr('href', web_url + '/home/kehu/systemEdit/type/kehu_qiyeleixing/id/' + bind);
                        break;
                    case 'delete':
                        layer.confirm('确定删除该公司类型吗', function(index) {
                            $.post(web_url + '/home/kehu/deleteSystemInfo/type/kehu_qiyeleixing', {id: bind}, function (obj, status) {
                                if (status === 'success') {
                                    if (obj.status === '1001') {
    ...
    var fromUrl = web_url + '/home/kehu/saveQiyeleixingInfo';
