<?php /*a:2:{s:63:"/var/www/manager_cmlaw/application/home/view/anjian/manage.html";i:1545186980;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="row pagetitle">
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-tabs-order">
            ...
            <?php endif; ?>
            <a href="<?php echo url('anjian/manage',['status'=>3]); ?>">进行中
                <?php if(!(empty($data['jinxingzhong']) || (($data['jinxingzhong'] instanceof \think\Collection || $data['jinxingzhong'] instanceof \think\Paginator ) && $data['jinxingzhong']->isEmpty()))): ?>
                <span class="badge" style="background-color: #e61b1b;margin-top: -4px;"><?php echo htmlentities($data['jinxingzhong']); ?></span>
                <?php endif; ?>
            </a>
            ...
            <li role="presentation" class="active">
                <?php else: ?><li role="presentation">
            <?php endif; ?>
            <a href="<?php echo url('anjian/manage',['status'=>2]); ?>">待审核
                <?php if(!(empty($data['daishenhe']) || (($data['daishenhe'] instanceof \think\Collection || $data['daishenhe'] instanceof \think\Paginator ) && $data['daishenhe']->isEmpty()))): ?>
                <span class="badge" style="background-color: #e61b1b;margin-top: -4px;"><?php echo htmlentities($data['daishenhe']); ?></span>
                <?php endif; ?>
            </a>
        </li>
...
<div class="table-responsive">
    <table class="table table-striped table-hover table-border-book">
        ...
        <tr>
            ...
            <td class="text-left"><?php echo htmlentities($list['kehu_name']); ?></td>
            ...
            <td class="text-right width160">
                <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">
                    ...
                    <button type="button" data-align="tools" data-target="renyuan" data-bind="<?php echo htmlentities($list['idanjian']); ?>"
                            class="btn btn-link btn-default">编辑团队
                    </button>
                    ...
                    <?php endif; if(in_array(($list['anjian_status']), explode(',',"1,4"))): ?>
