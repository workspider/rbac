<?php /*a:2:{s:74:"/var/www/manager_cmlaw/application/home/view/kehu/system/kehu_country.html";i:1547002980;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <tr>
                ...
                <td class="text-right width160">
                    <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">
                        ...
                        <button type="button" data-toggle="hr_fensuo" data-align="update" data-bind="<?php echo htmlentities($list['idkehu_country']); ?>"
                                class="btn btn-link btn-default">修改
                        </button>
                        <button type="button" data-toggle="hr_fensuo" data-align="delete" data-bind="<?php echo htmlentities($list['idkehu_country']); ?>"
        ...
        <form method="post" id='hrCreateForm'>
            ...
            <h4>国家信息修改
                <button type="button" data-toggle="hr_fensuo" data-align="create" data-bind=""
                        class="btn btn-link btn-default btn-sm">新增国家
                </button>
            </h4>
            <table class="table table-bordered">
                <tbody>
                <tr>
                    <td class="input-title text-right"><span>国家：</span></td>
                    <td>
                        <div class="width-100">
                            <input name="name" type="text" class="form-control" value="<?php echo htmlentities($data['info']['country_name']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <input name="id" type="hidden" value="<?php echo htmlentities($data['info']['idkehu_country']); ?>">
            <?php else: ?>
            <h4>国家新增</h4>
            <table class="table table-bordered">
                <tbody>
...
<script>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'hr_fensuo':
                switch (align) {
                    case 'create':
                        $(location).attr('href', web_url + '/home/kehu/system/type/kehu_country');
                        break;
                    case 'update':
                        $(location).attr('href', web_url + '/home/kehu/systemEdit/type/kehu_country/id/' + bind);
                        break;
                    case 'delete':
                        layer.confirm('确定删除该国家吗', function(index) {
                            $.post(web_url + '/home/kehu/deleteSystemInfo/type/kehu_country', {id: bind}, function (obj, status) {
                                if (status === 'success') {
                                    if (obj.status === '1001') {
    ...
    var fromUrl = web_url + '/home/kehu/saveGuojiaInfo';
