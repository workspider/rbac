<?php /*a:2:{s:64:"/var/www/manager_cmlaw/application/home/view/lichong/fankui.html";i:1545186973;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <td class="text-right width160">
                    <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">
                        <button type="button" data-toggle="kehu_geren" data-align="shenhe" data-bind="<?php echo htmlentities($list['idlichong']); ?>"
                                class="btn btn-circle btn-yeelibaray btn-default">反馈
                        </button>
                    </div>
                </td>
            </tr>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'kehu_geren':
                switch (align) {
                    case 'shenhe':
                        $(location).attr('href', web_url + '/home/lichong/fankuisee/id/' + bind);
                        break;
                    case 'delete':
