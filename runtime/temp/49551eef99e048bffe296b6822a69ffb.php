<?php /*a:2:{s:70:"/var/www/manager_cmlaw/application/home/view/kehu/qiye/qiyeupdate.html";i:1546853637;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-md-12">
            <table class="table table-no-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <select name="kehu_leixing" class="form-control chosen-select " data-placeholder="选择公司类型">
                                <option value=""></option>
                                <?php if(is_array($gongsileixing) || $gongsileixing instanceof \think\Collection || $gongsileixing instanceof \think\Paginator): $i = 0; $__LIST__ = $gongsileixing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gongsi): $mod = ($i % 2 );++$i;if($gongsi['qiyeleixing_name'] == $data['info']['kehu_leixing']): ?>
                                <option value="<?php echo htmlentities($gongsi['qiyeleixing_name']); ?>" selected><?php echo htmlentities($gongsi['qiyeleixing_name']); ?></option>
                                <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_faren" class="form-control" value="<?php echo htmlentities($data['info']['kehu_faren']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_xinyongdaima" class="form-control"
                                   value="<?php echo htmlentities($data['info']['kehu_xinyongdaima']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <input type="text" name="kehu_ziben" class="form-control" value="<?php echo htmlentities($data['info']['kehu_ziben']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-40">
                            <textarea name="kehu_dizhi" class="form-control" rows="6"><?php echo htmlentities($data['info']['kehu_dizhi']); ?></textarea>
                        </div>
                    </td>
