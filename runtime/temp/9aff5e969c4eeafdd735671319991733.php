<?php /*a:2:{s:61:"/var/www/manager_cmlaw/application/home/view/anjian/read.html";i:1545186980;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="row">
    <div class="col-md-12">
        <?php if($data['info']['anjian_status'] == '4'): ?>
        <div class="alert alert-danger" role="alert">
            <p>签批意见：<strong>驳回!</strong> <?php echo htmlentities($data['info']['shenpi_content']); ?></p>
            <p>签批日期：<?php echo htmlentities($data['info']['shenpi_datetime']); ?></p>
        </div>
        <?php endif; ?>
    </div>
    ...
    <!--<?php echo widget('anjian/getContent',['id'=>$data['id']]); ?>-->
