<?php /*a:2:{s:83:"/var/www/manager_cmlaw/application/home/view/kehu/system/kehu_zhengjianleixing.html";i:1545186989;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-6">
        <table class="table table-border-order">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($list['zhengjianleixing_name']); ?></td>
                <td><?php echo htmlentities($list['beizhu']); ?></td>
                <td class="text-right width160">
                    <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">

                        <button type="button" data-toggle="hr_lingyu" data-align="update" data-bind="<?php echo htmlentities($list['idkehu_zhengjianleixing']); ?>"
                                class="btn btn-link btn-default">修改
                        </button>
                        <button type="button" data-toggle="hr_lingyu" data-align="delete" data-bind="<?php echo htmlentities($list['idkehu_zhengjianleixing']); ?>"
        ...
        <form method="post" id='hrCreateForm'>
            ...
            <h4>证件类型信息修改
                <button type="button" data-toggle="hr_lingyu" data-align="create" data-bind=""
                        class="btn btn-link btn-default btn-sm">新增证件类型
                </button>
            </h4>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-100">
                            <input name="name" type="text" class="form-control" value="<?php echo htmlentities($data['info']['zhengjianleixing_name']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <input name="id" type="hidden" value="<?php echo htmlentities($data['info']['idkehu_zhengjianleixing']); ?>">
            <?php else: ?>
            <h4>证件类型新增</h4>
            <table class="table table-bordered">
                <tbody>
...
<script>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'hr_lingyu':
                switch (align) {
                    case 'create':
                        $(location).attr('href', web_url + '/home/kehu/system/type/kehu_zhengjianleixing');
                        break;
                    case 'update':
                        $(location).attr('href', web_url + '/home/kehu/systemEdit/type/kehu_zhengjianleixing/id/' + bind);
                        break;
                    case 'delete':
                        layer.confirm('确定删除该证件类型吗', function(index) {
                            $.post(web_url + '/home/kehu/deleteSystemInfo/type/kehu_zhengjianleixing', {id: bind}, function (obj, status) {
                                if (status === 'success') {
                                    if (obj.status === '1001') {
    ...
    var fromUrl = web_url + '/home/kehu/saveZhengjianInfo';
