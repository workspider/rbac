<?php /*a:2:{s:66:"/var/www/manager_cmlaw/application/home/view/lichong/create_2.html";i:1545186974;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td colspan="3" class="text-danger"><?php echo htmlentities($data['info']['gongshi_time']); ?></td>
            </tr>
            <tr>
    ...
    <div class="col-md-12">
        ...
        <table class="table table-border-book">
            ...
            <tr style="color: #ff0000">
              <!--<td>(<?php echo htmlentities($list['lichong_d_kehu']); ?>&nbsp/&nbsp<?php echo htmlentities($list['lichong_x_kehu']); ?>)</td>
                <td colspan="2">
                <td colspan="2">
                    <table class="table">
                        <?php if(is_array($list['anjian']) || $list['anjian'] instanceof \think\Collection || $list['anjian'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['anjian'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$anjian): $mod = ($i % 2 );++$i;?>
    ...
    <div class="col-md-12">
        <form method="post" id="lichongAddForm" novalidate="novalidate">
            <div class="text-center">
                ...
                <!--<input type="hidden" name="lichong_status" class="form-control" value="1"/>-->
                <a href="<?php echo url('lichong/index'); ?>" class="btn btn-lg btn-yeelibaray">完成</a>
            </div>
        </form>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function (obj) {
                    if (obj.status === 1001) {
                        ...
                        $(window).attr('location', web_url + "/home/lichong/index/");
                    } else {
