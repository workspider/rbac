<?php /*a:2:{s:58:"/var/www/manager_cmlaw/application/rbac/view/hr/index.html";i:1546067570;s:61:"/var/www/manager_cmlaw/application/rbac/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <td class="text-right width160">
                <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">
                    ...
                    <button type="button" data-toggle="user" data-align="update" data-bind="<?php echo htmlentities($list['iduser']); ?>"
                            class="btn btn-link btn-default">编辑
                    </button>
                    <button type="button" data-toggle="user" data-align="lizhi" data-bind="<?php echo htmlentities($list['iduser']); ?>"
                            class="btn btn-link btn-default">离职
                    </button>
                </div>
            </td>
        </tr>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'user':
                switch (align) {
                    case 'read':
                        $(location).attr('href', web_url + '/home/hr/read/id/' + bind);
                        break;
                    case 'update':
                        $(location).attr('href', web_url + '/home/hr/update/id/' + bind);
                        break;
                    case 'lizhi':
                        if (confirm('确认提交用户离职吗？') == true) {
                            $.post(web_url + '/home/hr/lizhi', {id: bind}, function (obj, status) {
                                if (status === 'success') {
                                    if (obj.status === '1001') {
