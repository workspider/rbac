<?php /*a:2:{s:60:"/var/www/manager_cmlaw/application/rbac/view/auth/index.html";i:1545186972;s:61:"/var/www/manager_cmlaw/application/rbac/view/public/base.html";i:1545996683;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-2">
        <div class="list-group">
            ...
            <button type="button" data-toggle="ajax" data-align="url" data-bind="<?php echo url('auth/index',['id'=>$list['id']]); ?>"
                    class="list-group-item">|--- <?php echo htmlentities($list['name']); ?>
            </button>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
        ...
        <div class="layui-table-body layui-table-main">
            <table class="table table-border-book">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php if(in_array(($l['type']), explode(',',"1"))): ?>菜单<?php else: ?>操作<?php endif; ?></td>
                    <td class="text-center"><?php echo htmlentities($l['paixun']); ?></td>
                ...
                <?php if(is_array($l['list']) || $l['list'] instanceof \think\Collection || $l['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $l['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo htmlentities($l['id']); ?></td>
                    <td>|------ <?php echo htmlentities($l['name']); ?></td>
                    <td><?php echo htmlentities($l['title']); ?></td>
