<?php /*a:2:{s:68:"/var/www/manager_cmlaw/application/home/view/user/system/fensuo.html";i:1546067575;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="row">
    <div class="col-md-6">
        <table class="table table-border-order">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($list['fensuo_biaoshi']); ?></td>
                <td></td>
                <td class="text-right width160">
                    <div class="btn-group btn-group-xs" role="group" aria-label="Extra-small button group">

                        <button type="button" data-toggle="hr_fensuo" data-align="update" data-bind="<?php echo htmlentities($list['idfensuo']); ?>"
                                class="btn btn-link btn-default">修改
                        </button>
                        <button type="button" data-toggle="hr_fensuo" data-align="delete" data-bind="<?php echo htmlentities($list['idfensuo']); ?>"
    ...
    <div class="col-md-6">
        <form method="post" id='hrCreateForm'>
            ...
            <h4>分所信息修改
                <button type="button" data-toggle="hr_fensuo" data-align="create" data-bind=""
                        class="btn btn-link btn-default btn-sm">新增分所
                </button>
            </h4>
            <table class="table table-bordered">
                <tbody>
                <tr>
                    <td class="input-title text-right"><span>分所：</span></td>
                    <td>
                        <div class="width-100">
                            <input name="name" type="text" class="form-control" value="<?php echo htmlentities($data['info']['fensuo_name']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="width-50">
                            <input name="biaoshi" type="text" class="form-control" value="<?php echo htmlentities($data['info']['fensuo_biaoshi']); ?>">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="width-100">
                            <textarea name="beizhu" class="form-control" rows="3"><?php echo htmlentities($data['info']['fensuo_beizhu']); ?></textarea>
                        </div>
                    </td>
                </tr>
                </tbody>
            </table>
            <input name="id" type="hidden" value="<?php echo htmlentities($data['info']['idfensuo']); ?>">
            <?php else: ?>
            <h4>分所新增</h4>
            <table class="table table-bordered">
                <tbody>
...
<script>
    ...
    $(document).on('click', 'button[type="button"]', function (event) {
        ...
        switch (toggle) {
            case 'hr_fensuo':
                switch (align) {
                    case 'create':
                        $(location).attr('href', web_url + '/home/user/system/type/fensuo');
                        break;
                    case 'update':
                        $(location).attr('href', web_url + '/home/user/systemEdit/type/fensuo/id/' + bind);
                        break;
                    case 'delete':
                        if (confirm('确定删除该分所吗？') == true) {
                            $.post(web_url + '/home/hr/deleteSystemInfo/type/fensuo', {id: bind}, function (obj, status) {
                                if (status === 'success') {
                                    if (obj.status === '1001') {
    ...
    var fromUrl = web_url + '/home/user/saveFensuoInfo';
