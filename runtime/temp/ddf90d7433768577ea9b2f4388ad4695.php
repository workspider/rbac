<?php /*a:2:{s:61:"/var/www/manager_cmlaw/application/home/view/user/update.html";i:1546067575;s:61:"/var/www/manager_cmlaw/application/home/view/public/base.html";i:1558926142;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <form method="post" id='userCreateForm'>
            <table class="table table-bordered">
                    ...
                    <td>
                        <div class="width-30">
                            <input name="user_realname" type="text" class="form-control"
                                   value="<?php echo htmlentities($data['info']['user_realname']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <input name="user_phone" type="text" class="form-control" value="<?php echo htmlentities($data['info']['user_phone']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-60">
                            <input name="user_email" type="text" class="form-control" value="<?php echo htmlentities($data['info']['user_email']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <input name="user_tel" type="text" class="form-control" value="<?php echo htmlentities($data['info']['user_tel']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-30">
                            <input name="user_fax" type="text" class="form-control" value="<?php echo htmlentities($data['info']['user_fax']); ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="width-100">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="user_sex" value="女" checked="checked"> 女
                            </label>
                            <?php endif; ?>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="width-30">
                            <select class="form-control chosen-select" name="fensuoid" data-placeholder="请选择分所">
                                <option value=""></option>
                                <?php if(is_array($data['fensuo']) || $data['fensuo'] instanceof \think\Collection || $data['fensuo'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['fensuo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if($list['idfensuo'] == $data['info']['fensuoid']): ?>
                                <option value="<?php echo htmlentities($list['idfensuo']); ?>" selected><?php echo htmlentities($list['fensuo_name']); ?></option>
                                <?php else: ?>
                    ...
                    <!--<td>-->
                        <!--<div class="width-30">-->
                            <!--<select class="form-control chosen-select" name="bumenid" data-placeholder="请选择所在部门">-->
                                ...
                                <!--<?php if($list['idbumen'] == $data['info']['bumenid']): ?>-->
                                <!--<option value="<?php echo htmlentities($list['idbumen']); ?>" selected><?php echo htmlentities($list['bumen_name']); ?></option>-->
                                <!--<?php else: ?>-->
                    ...
                    <td>
                        <div class="width-30">
                            <select class="form-control chosen-select" name="zhiweiid" data-placeholder="请选择职位">
                                <option value=""></option>
                                <?php if(is_array($data['zhiwei']) || $data['zhiwei'] instanceof \think\Collection || $data['zhiwei'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['zhiwei'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if($list['idzhiwei'] == $data['info']['zhiweiid']): ?>
                                <option value="<?php echo htmlentities($list['idzhiwei']); ?>" selected><?php echo htmlentities($list['zhiwei_name']); ?></option>
                                <?php else: ?>
                ...
                <tr style="display: none;">
                    ...
                    <td>
                        <div class="width-100">
                            <select class="form-control chosen-select" multiple name="user_lingyu[]"
                                    data-placeholder="选择业务领域">
                                <?php if(is_array($data['lingyu']) || $data['lingyu'] instanceof \think\Collection || $data['lingyu'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lingyu'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if(in_array(($list['idlingyu']), is_array($data['info']['user_lingyu'])?$data['info']['user_lingyu']:explode(',',$data['info']['user_lingyu']))): ?>
                                <option value="<?php echo htmlentities($list['idlingyu']); ?>" selected><?php echo htmlentities($list['lingyu_name']); ?></option>
                                <?php else: ?>
